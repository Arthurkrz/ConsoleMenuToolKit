...
using ConsoleMenuToolKit.ManualTests.Handlers;
using ConsoleMenuToolKit.ManualTests.Services.Async;
using ConsoleMenuToolKit.ManualTests.Services.Sync;
using ConsoleMenuToolKit.ManualTests.SubMenus;
using Microsoft.Extensions.DependencyInjection;

namespace ConsoleMenuToolKit.ManualTests.IOC
{
    public static class DependencyInjection
    {
        ...
        public static IServiceCollection InjectSubMenus(this IServiceCollection services)
        {
            services.AddSingleton<IConsoleMenuSubMenu, SubMenuAllItems>();
            services.AddSingleton<IConsoleMenuSubMenu, SubMenuSpecificItems>();
            return services;
        }
    }
}
