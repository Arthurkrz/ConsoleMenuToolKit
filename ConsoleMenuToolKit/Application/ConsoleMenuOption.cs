...
namespace ConsoleMenuToolKit.Application
{
    ...
    public sealed class ConsoleMenuOption
    {
        ...
        /// <summary>
        /// Creates a menu option of kind Action, used for simple asynchronous configuration. 
        ...
        {
            ArgumentException.ThrowIfNullOrWhiteSpace(handlerKey, nameof(handlerKey));
        ...
        {
            ArgumentException.ThrowIfNullOrWhiteSpace(subMenuKey, nameof(subMenuKey));
